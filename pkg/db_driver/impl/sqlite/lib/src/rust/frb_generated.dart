...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 2035853423;
...
abstract class RustLibApi extends BaseApi {
  Future<void> crateApiSqliteConnWrapperClose({required ConnWrapper that});

  Future<ConnWrapper> crateApiSqliteConnWrapperOpen({required String dsn});

  Stream<QueryStreamItem> crateApiSqliteConnWrapperQuery({
    required ConnWrapper that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiSqliteConnWrapperClose({required ConnWrapper that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSqliteConnWrapperCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSqliteConnWrapperCloseConstMeta =>
      const TaskConstMeta(debugName: "ConnWrapper_close", argNames: ["that"]);
  ...
  Future<ConnWrapper> crateApiSqliteConnWrapperOpen({required String dsn}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSqliteConnWrapperOpenConstMeta,
        argValues: [dsn],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSqliteConnWrapperOpenConstMeta =>
      const TaskConstMeta(debugName: "ConnWrapper_open", argNames: ["dsn"]);
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiSqliteConnWrapperQueryConstMeta,
  ...
  TaskConstMeta get kCrateApiSqliteConnWrapperQueryConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiInitGreetConstMeta =>
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerConnWrapper(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ConnWrapperImpl).frbInternalSseEncode(move: true),
      serializer,
    );
  }
  ...
  sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerConnWrapper(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ConnWrapperImpl).frbInternalSseEncode(move: null),
      serializer,
    );
  }
...
class ConnWrapperImpl extends RustOpaque implements ConnWrapper {
  ...
  Future<void> close() =>
      RustLib.instance.api.crateApiSqliteConnWrapperClose(that: this);

  Stream<QueryStreamItem> query({required String query}) => RustLib.instance.api
      .crateApiSqliteConnWrapperQuery(that: this, query: query);
}
