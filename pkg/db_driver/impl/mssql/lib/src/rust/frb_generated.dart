...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 271633572;
...
abstract class RustLibApi extends BaseApi {
  Future<void> crateApiMssqlConnWrapperClose({required ConnWrapper that});

  Future<ConnWrapper> crateApiMssqlConnWrapperOpen({required String dsn});

  Stream<QueryStreamItem> crateApiMssqlConnWrapperQuery({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiMssqlConnWrapperClose({required ConnWrapper that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMssqlConnWrapperCloseConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMssqlConnWrapperCloseConstMeta =>
  ...
  Future<ConnWrapper> crateApiMssqlConnWrapperOpen({required String dsn}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMssqlConnWrapperOpenConstMeta,
        argValues: [dsn],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMssqlConnWrapperOpenConstMeta =>
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiMssqlConnWrapperQueryConstMeta,
  ...
  TaskConstMeta get kCrateApiMssqlConnWrapperQueryConstMeta =>
      const TaskConstMeta(
...
class ConnWrapperImpl extends RustOpaque implements ConnWrapper {
  ...
  Future<void> close() =>
      RustLib.instance.api.crateApiMssqlConnWrapperClose(that: this);

  Stream<QueryStreamItem> query({required String query}) => RustLib.instance.api
      .crateApiMssqlConnWrapperQuery(that: this, query: query);
}
