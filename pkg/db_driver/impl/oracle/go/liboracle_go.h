...
extern int64_t oraclego_open(char* dsn, char** errOut);
extern void oraclego_close(int64_t handle);
extern int64_t oraclego_query_open(int64_t handle, char* sqlText, char** errOut);
extern void oraclego_query_close(int64_t queryHandle);
extern oracle_query_header_t* oraclego_query_header(int64_t queryHandle, char** errOut);
extern oracle_query_batch_t* oraclego_query_next_batch(int64_t queryHandle, int32_t batchSize, char** errOut);
